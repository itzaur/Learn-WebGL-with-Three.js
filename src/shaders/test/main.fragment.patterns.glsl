...
void main() {
    ...
    // gl_FragColor = vec4(1.0, 1.0, vRandom, 1.0);
    ...
    // float strength =  cos(vUv.x * 60.0);

    // float strength =  mod(vUv.x * 12.0, 1.0);
    ...
    // float strength = 1.0 - distance(vUv, vec2(0.5)) * 5.0;

    // float strength = 0.015 / distance(vUv, vec2(0.5));

    // vec2 lightX = vec2(vUv.x * 0.2 + 0.4, vUv.y * 0.5 + 0.25);
    ...
    // float strength = 1.0 - abs(sin(cnoise(vUv * 10.0)));

    // float strength = sin(cnoise(vUv * 10.0) * 20.0);


    float strength = step(0.1, sin(cnoise(vUv * 10.0) * 20.0));
